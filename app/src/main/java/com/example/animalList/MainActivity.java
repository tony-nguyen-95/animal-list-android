...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int[] ID_DRAWABLES = {R.drawable.ic_mess, R.drawable.ic_travel, R.drawable.ic_hospital,

            R.drawable.ic_hotel, R.drawable.ic_restaurant, R.drawable.ic_cooktail,

            R.drawable.ic_home, R.drawable.ic_work, R.drawable.ic_time, R.drawable.ic_education, R.drawable.ic_movie};
